                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="small-pieces-pounds" readonly>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="medium-pieces-pounds" readonly>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="large-pieces-pounds" readonly>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="halves-pieces-pounds" readonly>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="topping-pieces-pounds" readonly>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="oil-stock-pounds" readonly>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="user-input100 validate-input">
                                            <input class="user-input" type="number" name="blower-boxes-pounds" readonly>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="dynamic-inputs" id="small-pieces" type="number" name="small-pieces">
                                    </td>

                                    <td></td>
                                    <td>
                                        <button class="my-btn">Medium Pieces</button>
                                        <input class="dynamic-inputs" id="medium-pieces" type="number" name="medium-pieces">
                                    </td>

                                    <td></td>
                                    <td>
                                        <button class="my-btn">Large Pieces</button>
                                        <input class="dynamic-inputs" id="large-pieces" type="number" name="large-pieces">
                                    </td>

                                    <td></td>
                                    <td>
                                        <button class="my-btn">Halves and Pieces</button>
                                        <input class="dynamic-inputs" id="halves-pieces" type="number" name="halves-pieces">
                                    </td>

                                    <td></td>
                                    <td>
                                        <button class="my-btn">Topping Pieces</button>
                                        <input class="dynamic-inputs" id="topping-pieces" type="number" name="topping-pieces">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <input class="dynamic-inputs" id="blower-boxes" type="number" name="blower-boxes">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
